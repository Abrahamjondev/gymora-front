...
const HeroSection = () => {
	...
	return (
		...
		>
			...
			{/* Layer 1: Mesh gradient base — full width animated */}
			<div
				style={{
					position: 'absolute',
					inset: 0,
					background: 'linear-gradient(135deg, #0a1628 0%, #0d1f2d 20%, #0a2a2e 40%, #0d0d0e 60%, #121828 80%, #0a1e2a 100%)',
			...
			{/* Layer 2: Top-right cyan glow orb */}
			<div
				style={{
					position: 'absolute',
					top: '-15%',
					...
					height: '700px',
					borderRadius: '50%',
					background: 'radial-gradient(circle, rgba(0,220,229,0.08) 0%, rgba(0,180,200,0.03) 40%, transparent 70%)',
					filter: 'blur(60px)',
			...
			{/* Layer 3: Bottom-left teal glow orb */}
			<div
				style={{
					position: 'absolute',
					bottom: '-20%',
					...
					height: '600px',
					borderRadius: '50%',
					background: 'radial-gradient(circle, rgba(0,100,120,0.07) 0%, rgba(0,60,80,0.03) 40%, transparent 70%)',
					filter: 'blur(50px)',
			...
			<div
				style={{
					...
					width: '900px',
					height: '500px',
					background: 'radial-gradient(ellipse, rgba(0,220,229,0.05) 0%, rgba(0,150,170,0.02) 50%, transparent 80%)',
					zIndex: 1,
					pointerEvents: 'none',
				}}
			/>
				...
				>
					<button
						...
						onMouseOver={(e) => {
							...
							(e.currentTarget as HTMLElement).style.boxShadow = '0 0 50px rgba(0,220,229,0.4), 0 8px 24px rgba(0,0,0,0.3)';
						}}
						onMouseOut={(e) => {
			...
			<div
				style={{
					...
					right: 0,
					height: '120px',
					background: 'linear-gradient(to bottom, transparent, #0d0d0e)',
					zIndex: 5,
					pointerEvents: 'none',
				}}
			/>

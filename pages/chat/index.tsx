...
const ChatPage: NextPage = () => {
	...
	if (device === 'mobile') return <div style={{ padding: '24px', color: '#e5e2e3', background: '#131314' }}>CHAT MOBILE</div>;

	return (
		<div style={{ background: '#131314', minHeight: '100vh', padding: '40px 0' }}>
			<div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px', display: 'grid', gridTemplateColumns: '320px 1fr', gap: '0', height: 'calc(100vh - 144px)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '16px', overflow: 'hidden' }}>
				{/* Left — Conversations */}
...
export default withLayoutBasic(ChatPage);
